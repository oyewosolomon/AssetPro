...
const PricingCard: React.FC<PricingCardProps> = ({ tier, billingPeriod }) => {
  return (
    <div
      ...
      <div className="p-6 md:p-8">
        ...
        <div className="flex items-baseline mb-8">
          ...
          {billingPeriod === 'annually' && (
            <span className="text-blue-200 text-sm ml-2">Billed annually</span>
          )}
        </div>
